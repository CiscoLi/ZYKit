...
{
    UIScrollView *scrollView = (UIScrollView *)[self viewWithTag:kPageScrollViewTag];
    //判断是否为空
    if (scrollView == nil) {
        scrollView = [[UIScrollView alloc] init];
        [scrollView setFrame:self.frame];
        [scrollView setTag:kPageScrollViewTag];
...
-(void)setUpPageControl:(NSArray *)array
{
    ...
    if (pageControl == nil) {
        ...
        [pageControl setTag:kPageControlTag];
    ...
    pageControl.center = CGPointMake(self.center.x, self.scrollView.frame.origin.y + 125);
    pageControl.pageIndicatorTintColor = [UIColor colorWithRed:199/255.0 green:199/255.0 blue:199/255.0 alpha:0.4];
